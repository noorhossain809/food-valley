...
const dinners = [
    {
        imageURL: 'dinner1.png',
        name: 'Healthy Meal Plan',
        description: 'How we dream about our feature',
        price: '11.99'
    },
    {
        imageURL: 'dinner2.png',
        name: 'Fried Chicken Bento',
        description: 'How we dream about our feature',
        price: '14.69'
    },
    {
        imageURL: 'dinner3.png',
        name: 'Tarragon-Salmon',
        description: 'How we dream about our feature',
        price: '12.75'
    },
    {
        imageURL: 'dinner4.png',
        name: 'India Lunch-Meal',
        description: 'How we dream about our feature',
        price: '11.66'
    },
    {
        imageURL: 'dinner5.png',
        name: 'Beef Steack-vegetable',
        description: 'How we dream about our feature',
        price: '15.99'
    },
    {
        imageURL: 'dinner6.png',
...
const Dinner = () => {
    ...
    return (
        <div>
            ...
            <div className="row">
                {
                   dinners.map(dinner => <FakeData dinner={dinner}></FakeData>)
                }
            </div>
